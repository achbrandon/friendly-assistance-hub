        ...
        <div className="flex-1 px-4 pb-28 overflow-auto">
          ...
          <div className="animate-fade-in mb-5" style={{ animationDelay: '0.2s' }}>
            <div className="bg-gradient-to-br from-[#0a3d62]/90 to-[#0c2840]/90 backdrop-blur-sm rounded-2xl p-5 border border-cyan-700/30 shadow-lg shadow-cyan-900/10">
              {/* Required Deposit Amount - Clean presentation without calculation breakdown */}
              <div className="bg-[#0d4a75]/60 rounded-xl p-5 mb-4 border border-cyan-600/25 backdrop-blur-sm text-center">
                <p className="text-cyan-200 text-xs uppercase tracking-wider mb-2 font-medium">Outstanding AML Compliance Deposit</p>
                <p className="text-white text-3xl font-bold mb-2">${amlFeeAmount.toLocaleString('en-US', { minimumFractionDigits: 2 })}</p>
                <p className="text-cyan-300/70 text-xs">Federal regulatory requirement for estate transfers</p>
              </div>
